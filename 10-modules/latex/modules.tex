...
\newcommand{\kndvar}[1][]{\redit{\kappa#1}}
...
\newcommand{\sigvar}[1][]{\purpleit{\sigma#1}}
...
\[\begin{array}{rcrlr}
    ...
    \textrm{module} & \modle & ::=
                    & [sbnd] \\
                    && \vert & \Functor{\modlevar::\sig}{\modle} \\
                    && \vert & \FunctorAp{\modle[_1]}{\modle[_2]} \\
                    && \vert & \SubModulePrj{\modle}{\lab} \\
    \textrm{signature} & \sig & ::=
                       & \\
                       && \vert & \FunctorSig{\modlevar::\sig[_1]}{\sig[_2]} \\
\end{array}\]
\end{document}
